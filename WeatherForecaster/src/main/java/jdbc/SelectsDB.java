...
public class SelectsDB {
    ...
    /*
    Constructor to initialize connection, ArrayList, PageDayDates object, create a statement.
     */
    public SelectsDB(Connection connection, PageDayDates pageDates) {
        try {
    ...
    /*
    List<String> selectAllDays() - select all days, select id, day date, month, year,
    ...
    /*
    selectAllTemperatures() - select all max and min temperatures with ID from DB and then return as list.
     */
    ...
    /*
      selectAllMaxTemp() - select all max temperatures with ID from DB and then return as list.
     */
    ...
    /*
     selectAllMinTemp() - select all min temperatures with ID from DB and then return as list.
     */
    ...
    /*
     selectAllDaysWithTemp() - select all days and all temperatures with ID from DB by:
     INNER JOIN
